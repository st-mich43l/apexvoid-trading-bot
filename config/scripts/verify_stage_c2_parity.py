...
DIVERGENCES: dict[str, dict] = {
  ...
  "analysis.yml/analysis.technical_authority.mode": {"kind": "new_surfaced", "expected": "python", "reason": "S12A — Go analysis authority rollout gate; no old-config precedent. Default keeps Python authority."},
  "analysis.yml/analysis.technical_authority.consumer_enabled": {"kind": "new_surfaced", "expected": False, "reason": "S12A — starts the durable Go opportunity consumer; default off preserves Python-only production behaviour."},
